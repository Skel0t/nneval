...
uint8_t* sres(anydsl::Array<uint8_t>* pixels, int32_t width, int32_t height, anydsl::Array<anydsl::Array<float>*>* kernels1, anydsl::Array<anydsl::Array<float>*>* kernels2, anydsl::Array<anydsl::Array<float>*>* kernels3,
